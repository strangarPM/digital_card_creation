...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = Math.random(); //Local Storage Names for PWA
    var pwaRemind = 100000; //Days to re-remind to add to home
    ...
    function init_template(){
        ...
        if(splide.length){
            ...
            if(doubleSlider.length){
                doubleSlider.forEach(function(e){
                    var no_play = document.querySelectorAll("#"+e.id+ ".no-play");
                    var p = no_play.length?false:true;
        ...
        if(rememberHighlight){
            ...
            loadHighlight.className = "page-highlight";
            loadHighlight.type = "text/css";
            loadHighlight.href = 'https://drsafehands.com/resources/assets/app/styles/highlights/highlight_' + rememberHighlight +'.css';
        ...
        */
        ...
        if(workingHours.length){
            ...
            workingHours.forEach(function(entry) {
                ...
                if (matchDay === day[0]){
                    ...
                    if (now > day[1] && now < day[2] || now > day[3] && now < day[4]) {
                        document.querySelectorAll(matchData)[0].classList.add('bg-highlight');
        ...
        var plugLoc = "../resources/assets/app/plugins/"
        ...
        let plugins = [
          ...
          },
          {
            ...
            style: 'filterizr/filterizr.css?i=13',
