    ...
    <div>
                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <div>
                            <div class="mb-6 px-3">
                                ...
                                <h3 class="text-2xl font-bold">Sign in your account</h3>
                            </div>


                            <form method="POST" action="#" id="ajaxForm">
                                <input type="hidden" name="_token" value="Zh7I0I7mJ0GqsUDl2Jhnmtf9LOgpm7DWrgXCZDiU">
                                ...
                                <div class="px-3 text-center">
                                    <button type="submit"
                                        class="mb-2 w-full py-4 bg-green-600 shadow-lg hover:bg-green-700 rounded text-lg font-bold text-gray-50 transition duration-200">Sign
                                        In</button>
                                    <span class="text-gray-400 text-lg">
                                        <span>If you do not have an account?</span>
                                        <a class="text-green-600 hover:underline" href="{{route('register')}}">Sign Up</a>
                                    </span>
                                </div>
                            </form>
                        </div>
        ...
        <script>
            ...
            window.laravelCookieConsent = (function () {
                ...
                const COOKIE_DOMAIN = 'digitalCard';
